...
from cs336_basics import optimizer, model, nn_utils, data, tokenizer, utils
...
def run_multihead_self_attention(
    ...
    """
    mhsa = model.MultiHeadSelfAttention(num_heads, d_model)
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    mhsa = model.MultiHeadSelfAttention(num_heads, d_model, theta, max_seq_len)
    mhsa.load_state_dict({
        "linear_q.w": q_proj_weight,
        "linear_k.w": k_proj_weight,
        "linear_v.w": v_proj_weight,
...
def run_transformer_block(
    ...
    """
    transformer_block = model.TransformerBlock(num_heads, d_model, d_ff, theta, max_seq_len)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return optimizer.get_lr_cosine_schedule(it,
        max_learning_rate,
        min_learning_rate,
        warmup_iters,
        cosine_cycle_iters)
